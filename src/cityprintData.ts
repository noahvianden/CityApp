...
export const genericCurrentCity: City = {
  ...
  name: 'Current city',
  country: 'Works anywhere',
  status: 'GPS generated',
  savedProgress: 0,
  description: 'A flexible local atlas generated around your first GPS sample. Use this when you want Cityprint to work in any city.',
  initialRevealed: ['3-4'],
  ...
  places: [
    {
      ...
      description: 'The first anchor point for this generated local atlas.',
